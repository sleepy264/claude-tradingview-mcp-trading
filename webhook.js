    ...
    try {
      ...
      if (state.reentry) {
        ...
        if (kind === "limit") {
          ...
          // Aplica-se enquanto a ordem espera; depois de encher (status Filled, acima)
          // a posição É esta re-entrada.
